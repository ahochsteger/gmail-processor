...
Make sure, you've done the initial [Getting Started](getting-started.mdx#use-a-library-reference-recommended) steps before migrating the old configuration to the new format.

The [Playground](/playground?example=migrationAdvanced) provides a convenient way to migrate your old GMail2GDrive configuration to the new format of Gmail Processor by following these steps:
