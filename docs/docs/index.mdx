...
* The **[Getting Started Guide](getting-started.mdx)** shows how to setup Gmail Processor in Google Apps Script and quickly get it up and running.
* The **[Config Reference](reference/index.mdx)** provides detailed information about the Gmail Processor configuration.
