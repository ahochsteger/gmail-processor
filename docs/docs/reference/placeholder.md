...
| <a id="placeholder.message.body.match.1">`message.body.match.1`</a> | The matching regex group number as defined in the match config (e.g.: `"(?<url>https://raw\.githubusercontent\.com/ahochsteger/gmail-processor/main/src/e2e-test/files/[a-z-]+\.txt)"`). | `https://raw.githubusercontent.co...` |
| <a id="placeholder.message.body.match.url">`message.body.match.url`</a> | The matching named regex group name as defined in the match config (e.g.: `"(?<url>https://raw\.githubusercontent\.com/ahochsteger/gmail-processor/main/src/e2e-test/files/[a-z-]+\.txt)"`). | `https://raw.githubusercontent.co...` |
