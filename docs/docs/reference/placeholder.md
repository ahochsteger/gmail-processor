...
|------------|-------------|
| <a id="dateExpr.endOfDay">`endOfDay`</a> | See function [endOfDay](https://date-fns.org/v3.3.1/docs/endOfDay) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.endOfHour">`endOfHour`</a> | See function [endOfHour](https://date-fns.org/v3.3.1/docs/endOfHour) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.endOfISOWeek">`endOfISOWeek`</a> | See function [endOfISOWeek](https://date-fns.org/v3.3.1/docs/endOfISOWeek) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.endOfISOWeekYear">`endOfISOWeekYear`</a> | See function [endOfISOWeekYear](https://date-fns.org/v3.3.1/docs/endOfISOWeekYear) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.endOfMinute">`endOfMinute`</a> | See function [endOfMinute](https://date-fns.org/v3.3.1/docs/endOfMinute) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.endOfMonth">`endOfMonth`</a> | See function [endOfMonth](https://date-fns.org/v3.3.1/docs/endOfMonth) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.endOfQuarter">`endOfQuarter`</a> | See function [endOfQuarter](https://date-fns.org/v3.3.1/docs/endOfQuarter) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.endOfSecond">`endOfSecond`</a> | See function [endOfSecond](https://date-fns.org/v3.3.1/docs/endOfSecond) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.endOfToday">`endOfToday`</a> | See function [endOfToday](https://date-fns.org/v3.3.1/docs/endOfToday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.endOfTomorrow">`endOfTomorrow`</a> | See function [endOfTomorrow](https://date-fns.org/v3.3.1/docs/endOfTomorrow) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.endOfYear">`endOfYear`</a> | See function [endOfYear](https://date-fns.org/v3.3.1/docs/endOfYear) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.endOfYesterday">`endOfYesterday`</a> | See function [endOfYesterday](https://date-fns.org/v3.3.1/docs/endOfYesterday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.lastDayOfDecade">`lastDayOfDecade`</a> | See function [lastDayOfDecade](https://date-fns.org/v3.3.1/docs/lastDayOfDecade) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.lastDayOfISOWeek">`lastDayOfISOWeek`</a> | See function [lastDayOfISOWeek](https://date-fns.org/v3.3.1/docs/lastDayOfISOWeek) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.lastDayOfISOWeekYear">`lastDayOfISOWeekYear`</a> | See function [lastDayOfISOWeekYear](https://date-fns.org/v3.3.1/docs/lastDayOfISOWeekYear) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.lastDayOfMonth">`lastDayOfMonth`</a> | See function [lastDayOfMonth](https://date-fns.org/v3.3.1/docs/lastDayOfMonth) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.lastDayOfYear">`lastDayOfYear`</a> | See function [lastDayOfYear](https://date-fns.org/v3.3.1/docs/lastDayOfYear) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.nextFriday">`nextFriday`</a> | See function [nextFriday](https://date-fns.org/v3.3.1/docs/nextFriday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.nextMonday">`nextMonday`</a> | See function [nextMonday](https://date-fns.org/v3.3.1/docs/nextMonday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.nextSaturday">`nextSaturday`</a> | See function [nextSaturday](https://date-fns.org/v3.3.1/docs/nextSaturday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.nextSunday">`nextSunday`</a> | See function [nextSunday](https://date-fns.org/v3.3.1/docs/nextSunday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.nextThursday">`nextThursday`</a> | See function [nextThursday](https://date-fns.org/v3.3.1/docs/nextThursday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.nextTuesday">`nextTuesday`</a> | See function [nextTuesday](https://date-fns.org/v3.3.1/docs/nextTuesday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.nextWednesday">`nextWednesday`</a> | See function [nextWednesday](https://date-fns.org/v3.3.1/docs/nextWednesday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.previousFriday">`previousFriday`</a> | See function [previousFriday](https://date-fns.org/v3.3.1/docs/previousFriday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.previousMonday">`previousMonday`</a> | See function [previousMonday](https://date-fns.org/v3.3.1/docs/previousMonday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.previousSaturday">`previousSaturday`</a> | See function [previousSaturday](https://date-fns.org/v3.3.1/docs/previousSaturday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.previousSunday">`previousSunday`</a> | See function [previousSunday](https://date-fns.org/v3.3.1/docs/previousSunday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.previousThursday">`previousThursday`</a> | See function [previousThursday](https://date-fns.org/v3.3.1/docs/previousThursday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.previousTuesday">`previousTuesday`</a> | See function [previousTuesday](https://date-fns.org/v3.3.1/docs/previousTuesday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.previousWednesday">`previousWednesday`</a> | See function [previousWednesday](https://date-fns.org/v3.3.1/docs/previousWednesday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.startOfDay">`startOfDay`</a> | See function [startOfDay](https://date-fns.org/v3.3.1/docs/startOfDay) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.startOfDecade">`startOfDecade`</a> | See function [startOfDecade](https://date-fns.org/v3.3.1/docs/startOfDecade) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.startOfHour">`startOfHour`</a> | See function [startOfHour](https://date-fns.org/v3.3.1/docs/startOfHour) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.startOfISOWeek">`startOfISOWeek`</a> | See function [startOfISOWeek](https://date-fns.org/v3.3.1/docs/startOfISOWeek) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.startOfISOWeekYear">`startOfISOWeekYear`</a> | See function [startOfISOWeekYear](https://date-fns.org/v3.3.1/docs/startOfISOWeekYear) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.startOfMinute">`startOfMinute`</a> | See function [startOfMinute](https://date-fns.org/v3.3.1/docs/startOfMinute) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.startOfMonth">`startOfMonth`</a> | See function [startOfMonth](https://date-fns.org/v3.3.1/docs/startOfMonth) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.startOfQuarter">`startOfQuarter`</a> | See function [startOfQuarter](https://date-fns.org/v3.3.1/docs/startOfQuarter) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.startOfSecond">`startOfSecond`</a> | See function [startOfSecond](https://date-fns.org/v3.3.1/docs/startOfSecond) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.startOfToday">`startOfToday`</a> | See function [startOfToday](https://date-fns.org/v3.3.1/docs/startOfToday) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.startOfTomorrow">`startOfTomorrow`</a> | See function [startOfTomorrow](https://date-fns.org/v3.3.1/docs/startOfTomorrow) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.startOfYear">`startOfYear`</a> | See function [startOfYear](https://date-fns.org/v3.3.1/docs/startOfYear) of [date-fns](https://date-fns.org/). |
| <a id="dateExpr.startOfYesterday">`startOfYesterday`</a> | See function [startOfYesterday](https://date-fns.org/v3.3.1/docs/startOfYesterday) of [date-fns](https://date-fns.org/). |
