...
sidebar_position: 20
---
import script from '!!raw-loader!../../src/gas/examples/basics/simple.js';
import CodeBlock from '@theme/CodeBlock';
import { info } from "../../src/examples/basics/simple.ts";
...
6. Replace the contents of the initially created file `Code.gs` with the following code, take the config from the [Simple Example](examples/basics/simple.mdx) and save the changes:
  <details>
    ...
    <CodeBlock language="js" showLineNumbers>{script.replace(/^function simpleRun\b/,"function run")}</CodeBlock>
  </details>
