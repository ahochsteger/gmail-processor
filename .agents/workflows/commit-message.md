---
description: Generate a compliant commit message for the staged changes
---
...
4.  **Append Required Trailers** (only if the code has been modified with AI-assistance):
    - `AI-Assisted: true`
    - `AI-Tool: Antigravity`
