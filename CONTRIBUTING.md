...
- **Drafting All Releases**: All releases (Patch, Minor, and Major) are created as **Draft Releases**, securely gated behind manual maintainer approval. `release-please` automatically opens a **Draft Pull Request**. Once merged, the release is staged as a draft.
